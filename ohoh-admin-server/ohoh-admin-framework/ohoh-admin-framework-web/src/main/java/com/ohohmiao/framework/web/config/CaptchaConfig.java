package com.ohohmiao.framework.web.config;
...
public class CaptchaConfig {
    ...
    public DefaultKaptcha getMathCaptchaProducer(){
        ...
        // 验证码文本生成器
        properties.setProperty(KAPTCHA_TEXTPRODUCER_IMPL, "com.ohohmiao.framework.web.config.CaptchaTextCreator");
        // 验证码文本字符间距 默认为2
