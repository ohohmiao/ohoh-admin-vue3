		...
		<div class="table-header">
			...
			<div class="header-button-ri" v-if="toolButton">
				<slot name="toolButton">
					...
					<el-tooltip effect="dark" content="设置列" placement="top">
						<el-button :icon="Operation" circle v-if="columns.length" @click="openColSetting" />
					</el-tooltip>
					<el-tooltip effect="dark" :content="`${isShowSearch ? '隐藏搜索条' : '显示搜索条'}`" placement="top">
...
interface ProTableProps extends Partial<TableProps<any>> {
	...
	paginationLayout?: string; //分页组件样式  ==> 非必传（默认为'total, sizes, prev, pager, next, jumper'）
